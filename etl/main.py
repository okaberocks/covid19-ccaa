...
def add_metadata(json_file):
    """Add metadata to JSON generated by pyjstat."""
    json_decoded = json.loads(json_file)
    for key in etl_cfg.metadata:
        json_decoded[key] = etl_cfg.metadata[key]
    return json_decoded
...
json_file = str(add_metadata(json_file))
